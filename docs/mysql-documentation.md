...
`Wkg.EntityFrameworkCore.MySql` only provides the RECAP bindings for MySQL. For more information on how to use the RECAP framework, please refer to the [WKG Entity Framework Core documentation](core-documentation.md).
...
> :bulb: **Tip**
> It is recommended to read the [WKG Entity Framework Core documentation](core-documentation.md) before using the `Wkg.EntityFrameworkCore.MySql` package.

### Mapping Procedure Command Objects

Mapping RECAP Procedure Command Objects (PCOs) targeting MySQL follows the same pattern described in the [WKG Entity Framework Core documentation](core-documentation.md#getting-started-with-pco-mapping), however, there are some minor differences to be aware of:
