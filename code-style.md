...
25. Source lines must not exceed 196 characters. Do not wrap code merely to satisfy an 80-character convention. Prefer keeping related expressions, argument lists, parameter lists, and fluent calls on one line when they fit within 196 characters and remain readable. In particular, do not introduce temporary context objects or otherwise restructure code solely to reduce line length; wrap when it improves readability or when a line would exceed 196 characters.
