...
For more information on features specific to the Oracle bindings, please refer to the [WKG Entity Framework Core - Oracle Bindings](https://github.com/WKG-Software-GmbH/wkg-entity-framework-core/blob/main/docs/oracle-documentation.md) documentation.
